...
export class Renderer {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.programs = {
      plainColor: glUtil.createProgramInfo(
        this.gl,
        'v-plainColor',
        'f-plainColor',
      ),
  ...
  loadAssets() {
    ...
    textureAssets.forEach((filename) =>
      loadAsset(`assets/textures/${filename}`),
    );
    ...
    const textAssets = [
      ...
      {
        key: 'welcome',
        text: 'Welcome to my developer portfolio!',
        w: 1800,
        h: 80,
      },
      ...
      {
        key: 'this_desc_0',
        text: 'Aside from my projects, I hope you enjoy this ',
        w: 1200,
        h: 40,
      },
      {
        key: 'this_desc_1',
        text: "technical exploration. You're in a 2D raycaster,",
        w: 1400,
        h: 40,
      },
      {
        key: 'this_desc_2',
        text: 'which is a rendering system that was used by classic',
        w: 1800,
        h: 40,
      },
      {
        key: 'this_desc_3',
        text: 'games like DOOM and Wolfenstein3D',
        w: 800,
        h: 40,
      },
      // spenny
      ...
      {
        key: 'spenny_0',
        text: "'spenny' is a comparative budgeting mobile application.",
        w: 1800,
        h: 40,
      },
      {
        key: 'spenny_1',
        text: 'You can see how other people spend their money given certain criteria.',
        w: 2000,
        h: 40,
      },
      {
        key: 'spenny_2',
        text: 'All user data is aggregated with noise for user privacy.',
        w: 1800,
        h: 40,
      },
      {
        key: 'spenny_3',
        text: "If your criteria doesn't find any matches, data",
        w: 1600,
        h: 40,
      },
      {
        key: 'spenny_4',
        text: "pulled from Canada's financial statistics will be used instead.",
        w: 1900,
        h: 40,
      },
      {
        key: 'spenny_5',
        text: 'This project was a fun foray into mobile development and React',
        w: 1800,
        h: 40,
      },
      {
        key: 'spenny_6',
        text: 'Native was generally enjoyable to work with. This also',
        w: 1600,
        h: 40,
      },
      {
        key: 'spenny_7',
        text: 'opened the door to cross-platform mobile development.',
        w: 1800,
        h: 40,
      },
      // staiir
      ...
      {
        key: 'staiir_0',
        text: "'staiir' is a Push/Pull/Leg workout routine mobile",
        w: 1600,
        h: 40,
      },
      {
        key: 'staiir_1',
        text: 'application. This app can be used to store, generate, and track',
        w: 2000,
        h: 40,
      },
      {
        key: 'staiir_2',
        text: 'workouts. The randomization functionality is core to this app',
        w: 1900,
        h: 40,
      },
      {
        key: 'staiir_3',
        text: 'but the v2 I intend to release will push it further!',
        w: 1600,
        h: 40,
      },
      {
        key: 'staiir_4',
        text: 'Another application with React Native, and a fun one to boot.',
        w: 1900,
        h: 40,
      },
      {
        key: 'staiir_5',
        text: 'My objective with this application was to keep the scope as tight as',
        w: 2100,
        h: 40,
      },
      {
        key: 'staiir_6',
        text: 'possible, while maintaining enough functionality so that',
        w: 1600,
        h: 40,
      },
      {
        key: 'staiir_7',
        text: 'I could personally use it daily!',
        w: 1000,
        h: 40,
      },
      // particlelife
      ...
      {
        key: 'plife_0',
        text: 'Emergence is beautiful, I tried to achieve it here, and sadly,',
        w: 2200,
        h: 40,
      },
      {
        key: 'plife_1',
        text: "the screenshot doesn't do it justice. This is a particle life",
        w: 2200,
        h: 40,
      },
      {
        key: 'plife_2',
        text: 'simulation I built to learn WebGL, I highly suggest visiting',
        w: 2200,
        h: 40,
      },
      {
        key: 'plife_3',
        text: 'the website and playing around with the parameters.',
        w: 1800,
        h: 40,
      },
      {
        key: 'plife_4',
        text: 'The simplicity in the parameters for this simulation',
        w: 1800,
        h: 40,
      },
      {
        key: 'plife_5',
        text: 'are what drew me to complete this. Later on,',
        w: 1800,
        h: 40,
      },
      {
        key: 'plife_6',
        text: 'I intend to attempt 3D cellular automata once I head into OpenGL',
        w: 2200,
        h: 40,
      },
      // voichess
      ...
      {
        key: 'voichess_0',
        text: 'Voice controlled chess, need I say more?',
        w: 1200,
        h: 40,
      },
      {
        key: 'voichess_1',
        text: 'Play against a computer with a basic AABB search, or create',
        w: 1900,
        h: 40,
      },
      {
        key: 'voichess_2',
        text: 'a lobby and invite your friends!',
        w: 900,
        h: 40,
      },
      {
        key: 'voichess_3',
        text: 'The purpose of this project was to explore websockets and to',
        w: 1900,
        h: 40,
      },
      {
        key: 'voichess_4',
        text: 'familiarize myself with Socket.io. The voice interpretation model',
        w: 2200,
        h: 40,
      },
      {
        key: 'voichess_5',
        text: 'is powered by Picovoice, a really cool company you should check out.',
        w: 2200,
        h: 40,
      },
      {
        key: 'voichess_6',
        text: 'My API token is limited to 3 users per month, kinda cringe.',
        w: 2000,
        h: 40,
      },
      // helcim
      ...
      {
        key: 'questie_0',
        text: 'There were a couple things I wanted to experiment with for this',
        w: 1900,
        h: 40,
      },
      {
        key: 'questie_1',
        text: 'project. Most importantly: passwordless authentication, mobile',
        w: 1800,
        h: 40,
      },
      {
        key: 'questie_2',
        text: 'push notifications, and developing a visual language (with solid)',
        w: 2000,
        h: 40,
      },
      {
        key: 'questie_3',
        text: 'components to re-use in the future.',
        w: 900,
        h: 40,
      },
      {
        key: 'questie_4',
        text: 'The application is a straightforward to-do list application.',
        w: 1800,
        h: 40,
      },
      {
        key: 'questie_5',
        text: 'Nothing particularly fancy, this was a learning project in',
        w: 1600,
        h: 40,
      },
      ...
      {
        key: 'truthmedia_0',
        text: 'I apologize in advance for creating this. This was a weekend',
        w: 1900,
        h: 40,
      },
      {
        key: 'truthmedia_1',
        text: 'project I made with my friend Matt Kadatz.',
        w: 1000,
        h: 40,
      },
      {
        key: 'truthmedia_2',
        text: "The intention behind the project was to play around with OpenAI's",
        w: 2000,
        h: 40,
      },
      {
        key: 'truthmedia_3',
        text: 'API. It was also just a fun weekend activity.',
        w: 1600,
        h: 40,
      },
      {
        key: 'truthmedia_4',
        text: 'The project was built with NextJS (against my wishes) and we',
        w: 1900,
        h: 40,
      },
      {
        key: 'truthmedia_5',
        text: 'have a CRON running daily (nodejs) that generates more fake content.',
        w: 2000,
        h: 40,
      },
      {
        key: 'truthmedia_6',
        text: 'If you figure out the secret code, you can create your own articles ;).',
        w: 2000,
        h: 40,
      },
      // noti
  ...
  drawGrid(nx: number, ny: number, cellWidth: number, cellHeight: number) {
    ...
    glUtil.setBuffersAndAttributes(
      this.programs.plainColor.attributeSetters,
      bufferInfo,
    );
  ...
  drawPlayer(player: Player) {
    ...
    for (let i = 1; i <= steps; i++) {
      ...
      let newX =
        player.r * Math.cos(degToRad((360 / steps) * i)) + player.pos.x;
      let newY =
        player.r * Math.sin(degToRad((360 / steps) * i)) + player.pos.y;
    ...
    let dirLineIndices = [
      player.pos.x,
      player.pos.y,
      Math.cos(player.lookDir.x) * player.r + player.pos.x,
      Math.sin(player.lookDir.x) * player.r + player.pos.y,
      player.pos.x,
      player.pos.y,
      Math.cos(player.lookDir.x + Math.PI / 8) * player.r + player.pos.x,
      Math.sin(player.lookDir.x + Math.PI / 8) * player.r + player.pos.y,
      player.pos.x,
      player.pos.y,
      Math.cos(player.lookDir.x - Math.PI / 8) * player.r + player.pos.x,
      Math.sin(player.lookDir.x - Math.PI / 8) * player.r + player.pos.y,
...

    {
      const attribArrays: Record<string, glUtil.AttribArray> = {
        a_position: {
          numComponents: 2,
          data: new Float32Array(dirLineIndices),
        },
      };

      const bufferInfo = glUtil.createBufferInfoFromArrays(
        this.gl,
        attribArrays,
      );
  ...
  drawWalls(
    ...
    const relative = (lookDir.y / fov.y) * 0.5;
    ...
    glUtil.setBuffersAndAttributes(
      this.programs.walls.attributeSetters,
      bufferInfo,
    );
    const uniforms = {
      u_resolution: [this.w, this.h],
  ...
  drawGround(verticalFov: number, lookDirY: number) {
    const relative = (lookDirY / verticalFov) * 0.5;
    const relativeH = this.h * (0.5 + relative);
  ...
  drawSprite(
    ...
    const topLeft = {
      x: xpos - sprite.w * relativeY * 0.5,
      y: relativeH - sprite.z * relativeY - sprite.h * relativeY * 0.5,
    };
    ...
    const texIndices = [0, 0, 0, 1, 1, 1, 0, 0, 1, 0, 1, 1];

    const relDist = 1 - spriteDist / renderDistance;
    const distIndices = [relDist, relDist, relDist, relDist, relDist, relDist];
    ...
    this.gl.drawArrays(this.gl.TRIANGLES, 0, indices.length / 2);
  ...
  drawEntities(
    ...
    sprites.sort(
      (a, b) => a.pos.sub(player.pos).mag - b.pos.sub(player.pos).mag,
    );
    ...
    while (unrenderedSprites.length) {
      ...
      const { furtherRays, closerRays } = unrenderedRays.reduce(
        (acc, curr) => {
      ...
      if (furtherRays.length) {
        ...
        rayGroups.forEach((_rays) => {
          this.drawWalls(_rays, fov, player.lookDir, nRays, _rays[0].index);
        });
      }

      this.drawSprite(
        furthestUnrenderedSprite,
        fov,
        player.pos,
        player.lookDir,
        renderDistance,
